...
<html lang="pl">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#registration">Zaloguj się</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <section class="page-section" id="registration">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Ucz się od najlepszych</h2>
                    <h3 class="section-subheading text-muted">Aby zarejstować się na kurs wypełnij poniższy formularz.</h3>
                </div>
                <form id="registrationForm" onsubmit="return sprawdz()">
                    <div class="row align-items-stretch mb-6">
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" id="phone" type="text" name="phone"  placeholder="Numer telefonu*" aria-label="phone" aria-describedby="basic-addon1">
                                <p class="help-block text-danger" id="phoneError"></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input class="form-control" id="adress" type="text" name="adress" placeholder="Adres *" required="required" />
                                <p class="help-block text-danger" id="adressError"></p>
                            </div>
                            <div class="form-group mb-md-0">
                                <input class="form-control" id="age" type="text" name="age" placeholder="Wiek *" required="required" />
                                <p class="help-block text-danger" id="ageError"></p>
                            </div>

                        </div>
                    </div>
                    <div class="row algin-items-stretch mb-6">
                        <div class="col-md-6">
                            <div class="text-center">
                                <h5>Wybierz rodzaj kursu</h5>
                            </div>
                            <div class="form-check ">
                                <input class="form-check-input" type="checkbox" name="produkt" value="AdministracjaSieci" id="administracjaSieci">
                                <label class="form-check-label" for="administracjaSieci">
                                Administracja sieci
                                </label>
                            </div>
                            <div class="form-check ">
                                <input class="form-check-input" type="checkbox" name="produkt" value="AplikacjeInternetowe" id="aplikacjeInternetowe" >
                                <label class="form-check-label" for="aplikacjeInternetowe">
                                Aplikacje internetowe
                                </label>
                            </div>
                            <div class="form-check ">
                                <input class="form-check-input" type="checkbox" name="produkt" value="bezpieczenstwoInformacji" id="bezpieczenstwoInformacji" >
                                <label class="form-check-label" for="bezpieczenstwoInformacji">
                                Bezpieczeństwo Informacji
                                </label>
                            </div>
                            <p class="help-block text-danger" id="checkError"></p>
                        </div>
                        <div class="col-md-6">
                            <div class="text-center">
                                <h5>Wybierz rodzaj zapłaty</h5>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="zaplata" id="karta" value="karta" checked>
                                <label class="form-check-label" for="karta">
                                  Karta
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="zaplata" id="gotowka" value="gotowka">
                                <label class="form-check-label" for="gotowka">
                                  Gotówka
                                </label>
                            </div>
                            <div class="form-check ">
                                <input class="form-check-input" type="radio" name="zaplata" id="przelew" value="przelew" >
                                <label class="form-check-label" for="przelew">
                                  Przelew
                                </label>
                            </div>
                        </div>
                    <div class="text-center">
                        <div id="success"></div>
                        <button class="btn btn-primary btn-xl text-uppercase" id="sendMessageButton" type="submit">Zapisz się!</button>
                        
                    </div>
                    <div class="text-center" id="change"></div>
                    </div>
                </form>
            </div>
        </section>
